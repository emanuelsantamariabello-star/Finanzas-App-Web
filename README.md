...
La versión **v1.2** incorpora registro e inicio de sesión con Google, manteniendo contraseña local de seguridad para cambios críticos, conservando el flujo tradicional de acceso y ajustando la experiencia visual del botón de Google en modo oscuro.
